...
class RegisteringUserSpec extends AbstractModelsTest {
  ...
  val registeringUserModel: RegisteringUser = RegisteringUser(password = "testPassword", businessName = "testBusinessName", email = "test@gmail.com", contactNumber = "98765".toLong, moc = List("test"), propertyNumber = "test", postcode = "test")
