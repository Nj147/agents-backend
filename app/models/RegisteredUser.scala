...
case class AgentDetails(arn: String, businessName: String, email: String, mobileNumber: Int, moc: String, propertyNumber: String, postcode: String)
...
case class RegisteringUser(password: String, businessName: String, email: String, mobileNumber: Int, moc: String, propertyNumber: String, postcode: String)
